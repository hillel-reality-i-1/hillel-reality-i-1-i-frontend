  ...
  return (
    <>
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.info}><p className={styles.info__type}>Біографія</p> <Link className={styles.info__link}>Hello! I am a UX/UI... {data.about_my_self}<Arrow /> </Link> </div>
