          ...
          <div className={`${styles.signIn} `}>
            ...
            <div className={styles.signIn__wrapper}>
              ...
              <a className={styles.signIn__google} href='/'>
                <img src={googleIcon} alt='google logo'/> Продовжити через Google
              </a>
              ...
              >
                <div className={styles.signIn__form__component}>
                  ...
                  {formik.touched.email && formik.errors.email && (
                    <div className={styles.form__error}> <img src={errorIcon} alt='Error icon' /> {formik.errors.email}</div>
                  )}
                </div>
                ...
                <div className={styles.signIn__form__component}>
                  ...
                  {formik.touched.password && formik.errors.password && (
                    <div className={styles.form__error}> <img src={errorIcon} alt='Error icon' />{formik.errors.password}</div>
                  )}
                  {loginError && (
